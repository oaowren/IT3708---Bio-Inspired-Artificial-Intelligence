...
problem_number = "86016"
# you may have to specify the complete path
optimalFolder = path + os.sep + "Optimal_Segmentation_Files" + os.sep + problem_number
# you may have to specify the complete path
studentFolder = path + os.sep + "Student_Segmentation_Files" + os.sep + problem_number
        ...
        for h in range(height):
            ...
            if color1 < blackValueThreshold:
                ...
                if(int(color1) == int(color2)):
                    ...
                    correctFound = False
                    for w2 in range(
                            w - pixelRangeCheck, w + pixelRangeCheck + 1):
                        if(correctFound):
                            break
                        for h2 in range(
                                h - pixelRangeCheck, h + pixelRangeCheck + 1):
