...
class MOEA {
    ...
    public static void main(String[] args) {
        ...
        Path pathBlack = Path.of("MOEA/evaluator/Student_Segmentation_Files/" + Parameters.filename + "/");
        Path pathGreen = Path.of("MOEA/evaluator/Student_Segmentation_Files_Green/" + Parameters.filename + "/");
