...
public class ImageSegmentationIO {
    ...
    public ImageSegmentationIO(String fileName) {
        try (InputStream input = new FileInputStream(new File("MOEA/training_images/" + fileName+ "/Test image.jpg"))) {
    ...
    public void save(String path, Individual solution, String color, boolean debug){
        ...
        String numberOfSegments = solution.getNoOfSegments() + "_" + solution.getConnectivity() + "_" + solution.getDeviation()+ "_" + solution.getEdgeValue();
        String fullPath = "MOEA/evaluator/Student_Segmentation_Files" + folder + "/" + path + "/" + fileSuffix + (debug ? printedDebugImageCount++ : numberOfSegments) + ".jpg";
